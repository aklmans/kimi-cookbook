...
/* [src, startSec, windowSec, speed, caption] — 16 segments ≈ 96s montage. */
const SEGMENTS = [
  ["A", 295, 30, 5, "小程序,从空项目开始"],
  ["A", 1495, 30, 5, "月亮封面,在模拟器里亮了"],
  ["A", 2995, 30, 5, "界面,一版一版调"],
  ["A", 3895, 30, 5, "页面一个个长出来"],
  ["A", 5395, 30, 5, "代码推到仓库"],
  ["A", 5695, 30, 5, "报错是日常"],
  ["A", 6595, 30, 5, "写书的,也是 Kimi"],
  ["B", 595, 30, 5, "书稿逐章打磨"],
  ["B", 1795, 30, 5, "下半场,继续"],
  ["B", 2695, 30, 5, "边查资料边写"],
  ["B", 3295, 30, 5, "再报错,再修"],
  ["B", 4200, 30, 5, "和 Kimi 对稿改稿"],
  ["B", 5995, 30, 5, "网站能读了"],
  ["B", 6300, 30, 5, "部署,也是开发的一部分"],
  ["B", 6600, 30, 5, "收尾:发布与整理"],
  ["B", 6895, 30, 5, "一书三端,上线"],
];
