...
然后按需为我总结要点、回答具体问题、做读书笔记。引用时请保留作者署名 (Zhaphar) 和章节链接。书的网页版 (含评论): ${bookUrl}`
        : `Please read "Kimi · From Long Context to an Agent Stack" — a book by Zhaphar about the Kimi agent stack (10 chapters, in Chinese): the K3 and K2.7-Code models, the four modes, Agent and Agent Swarm, Deep Research, Kimi Code and the open API, and which of the five membership tiers is worth it.
...
Then summarize, answer specific questions, or make notes as I ask. Keep the author attribution (Zhaphar) and chapter links when you quote. Web edition (with comments): ${bookUrl}`;
